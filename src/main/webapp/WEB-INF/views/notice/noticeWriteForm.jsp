		...
		<div class="mainView">
			<div class="selectNav">
				<ul class="selectNavUl">
					...
					<li class="selectNavLi">></li>
					<li class="selectNavLi">공지사항 작성</li>
				</ul>
			</div>
				...
				<div class="wrapper">
					<div class="wrapper-one">
						<div class="wrapper-one-one">
							<p style="font-size:140%; background-color:#dfdfdf;">공지사항 작성페이지</p>
							<h4>제목</h4>
							<input type="text" name="notice_title" placeholder="제목을 작성하세요.">

							<h4>내용</h4>
							<textarea name="notice_content" placeholder="내용을 작성하세요."></textarea>
						</div>
						<div class="wrapper-one-two">
							<input id="complete" type="submit" value="작성완료"> &nbsp; <input
								id="cancel" type="button" value="작성취소"
