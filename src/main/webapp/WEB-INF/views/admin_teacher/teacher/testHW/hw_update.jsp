	...
	<div class="mainView">
			<div class="selectNav">
				<ul class="selectNavUl">
					...
					<li class="selectNavLi">></li>
					<li class="selectNavLi">출제 과제 수정</li>
				</ul>
			</div>
			<div>
				<div style="margin-top:10px;">
					<div style="font-weight:bold;">${ requestScope.className }</div>
				<form action="Thwupdate.do" method="post"  enctype="multipart/form-data">
				<div style="margin-top:10px;">
				...
				<div>제 목 : </div>
				<input style="margin-left:20px;width:657px;"type="text" name="THWTitle" value="${requestScope.TH.THWTitle }">
				</div>
				<div style="display:flex; margin-top:10px; align-content: center;">
				<div>마감 날짜 : </div>
				
				<input style="margin-left:20px; height:12px;"type="date" name="HWEndDate" value="${requestScope.TH.HWEndDate }">
				<c:if test="${ !empty requestScope.TH.THWFile }">
					<div style="margin-left:20px;">첨부 파일 : </div>
					<div style="margin-left:20px;">${requestScope.TH.THWFile }</div>
				<input type="checkbox" name="deleteFlag" value="yes" style="margin-left:20px;"> 
					
						<div style="margin-left:20px;">파일삭제 </div>
						<div style="margin-left:20px;">변경 : <input style="font-size:10px;" type="file" name="upfile"></div>
					
				</c:if>
		
				<c:if test="${ empty requestScope.TH.THWFile }">
					<div>
					<div style="margin-left:20px;">첨부된 파일 없음</div>
					<div style="margin-left:20px;">추가 : <input style="font-size:10px;"type="file" name="upfile"></div>
					</div>
				</c:if>	
				<div>
						</div>
				...
				<div>
				<textarea name="THWContent" rows="10" cols="100" style="resize: none;border:solid 1px green"name="HWComent" placeholder="과제에 대한 코멘트를 남겨주세요.">${ requestScope.THWContent }</textarea>
				</div>
				<div>
