...
function checkInput() {
    ...
    if (testScore && testQ && testRA && ability !== '능력별단위요소' ) {
...
function deleteMProb(value){
	console.log(value);
	location.href = "${ pageContext.servletContext.contextPath}/delMprop.do?testNo=" + value + "&testCode=" + $('#testCode').val();
	$(document).ready(function() {
	alert('문제 삭제 완료');
	});
...
function updateMProb(value){
	...
	$('#utestScore').val(values[4]);
	$('#utestRA').val(values[3]);
	$('#utestQ').val(values[2]);
	      ...
	      success: function(data){
	         ...
	         for(var i in json.list){
	            values += "<tr class='proptd'><td>" + json.list[i].testnol 
	                  ...
	                  + "</td><td>"
	                  + "<button class='btnprop' value='"+ json.list[i].testnol  +"' onclick='deleteMProb(this.value);'>삭제하기</button>"
	                  + "</td></tr>";
	         }
		...
		<div class="mainView">
			<div class="selectNav">
				<ul class="selectNavUl">
					...
					<li class="selectNavLi">></li>
					<li class="selectNavLi">주관식 문제생성</li>
				</ul>
			</div>
			<div>
				<div>
					...
					<form action="insertProb.do" method="post">
						...
						<ul style="display:flex">
							...
							<li>배점<input type="number" id="testScore" name="testScore"
								oninput="checkInput();" style="width:37px;"></li>
						</ul>
						<ul>
							<li>문제<input type="text" id="testQ" name="testQ"
								oninput="checkInput();"style="width:280px;"></li>
							<li>정답<input type="text" id="testRA" name="testRA"
								oninput="checkInput();"style="width:280px;"></li>
				...
				<div  id="fixnone" style="width:350px; background-color: white; position:absolute;z-index:2;top:66px;display:none;">
					<form action="updateMprop.do" method="post">
						...
						<ul>
							...
							<li>문제<input type="text" id="utestQ" name="testQ"
								oninput="ucheckInput();"style="width: 280px;"></li>
							<li>정답<input type="text" id="utestRA" name="testRA"
								oninput="ucheckInput();"style="width: 280px;"></li>
