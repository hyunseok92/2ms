		...
		<div class="mainView">
			...
			<div class="selectNav">
				<ul class="selectNavUl">
					...
					<li class="selectNavLi">></li>
					<li class="selectNavLi">과정 상세보기</li>
				</ul>
			</div>
			<div class="wrapper">
			
			<div class="wrapper-one">
			<input type="hidden" id="classCode" value="${ requestScope.course.classCode }">
			
			<h3>과정명</h3>
			<hr width="500" color="#afafaf" style="margin-top:5px"><br>
			<p>${ requestScope.course.className }</p><br>
			
			<h3>학습목표</h3>
			<hr width="500" color="#afafaf" style="margin-top:5px"><br>
			<p style="width:500px; line-height:1.1;">${ requestScope.course.classGoal }</p><br>
			
			<h3>시행연도</h3>
			<hr width="500" color="#afafaf" style="margin-top:5px"><br>
			개강일 : <input type="date" id="executeDate" value="${fn:substring(course.executeDate, 0, 10)}"/>
			<p>종강일 : ${fn:substring(endDate, 0, 10)}</p><br>
			
			<h3>교강사명</h3>
			<hr width="500" color="#afafaf" style="margin-top:5px"><br>
			<p>${ requestScope.course.name } 강사</p><br>

			<h3>교과목</h3>
			<hr width="500" color="#afafaf" style="margin-top:5px"><br>
			<table align="center" width="500" border="0" cellspacing="0" cellpadding="5">
				<tr>
					<th>주차</th><th>과목명</th><th>시수</th>
				</tr>
				
			<c:forEach var="subj" items="${ requestScope.dslist }" varStatus="loopStatus">
				<tr>
			...
			<br><hr width="500" color="#afafaf" style="margin-top:5px; margin-bottom:5px;">
			<table align="center" width="500" border="0" cellspacing="0" cellpadding="5">
		    <tr>
		    	<td></td>
		        <td style="text-align: center;"><strong>합산시수</strong> : ${totalTime} 시간</td>
		    </tr>

		    <tr>
		    	<td></td>
		        <td style="text-align: center;"><strong>전체 교육일수</strong> : ${ (totalTime / 8) } 일</td>
		    </tr>
		    <tr>
		    	<td></td>
		        <td style="text-align: center;"><p style="font-size:70%">※ 교육일수는 일일 8시간을 기준으로 합니다.</p></td>
		    </tr>
		    </table>

			<div class="buttons">
			<button onclick="history.go(-1);">목록으로</button> &nbsp; 		
			<button onclick="editCourse()">시행일자 확정</button>
			</div>
				</div>
			</div>
		</div>
